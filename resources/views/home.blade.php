	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="index.html" class="logo"> <img src="{{ asset('images/logo.png') }}"><span class="logoclass">HOTEL</span> </a>
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Subscriptions</span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">Suscribers </a></li>
								<li><a href="edit-booking.html"> Edit Booking </a></li>
								<li><a href="add-booking.html"> Add Booking </a></li>
							</ul>
						</li>
						
						<li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Team </span> <span class="menu-arrow"></span></a>
						...
						<li> <a href="assets.html"><i class="far fa-money-bill-alt"></i> <span>Donations</span></a> </li>
						<li> <a href="activities.html"><i class="far fa-bell"></i> <span>Gallery</span></a> </li>
						<li class="submenu"> <a href="#"><i class="fe fe-table"></i> <span> Testimonials </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
